# Awesome Terraform [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 462,163 | 🐛 73 | 📅 2026-05-03 <!-- omit in toc --> with stars

[![Link Checker](https://github.com/shuaibiyy/awesome-tf/actions/workflows/link-checker.yml/badge.svg)](https://github.com/shuaibiyy/awesome-tf/actions/workflows/link-checker.yml) ⭐ 6,437 | 🐛 8 | 📅 2026-05-03
[![Misspell Check](https://github.com/shuaibiyy/awesome-tf/actions/workflows/misspell.yml/badge.svg)](https://github.com/shuaibiyy/awesome-tf/actions/workflows/misspell.yml) ⭐ 6,437 | 🐛 8 | 📅 2026-05-03
[![Not Found Check](https://github.com/shuaibiyy/awesome-tf/actions/workflows/notfound.yml/badge.svg)](https://github.com/shuaibiyy/awesome-tf/actions/workflows/notfound.yml) ⭐ 6,437 | 🐛 8 | 📅 2026-05-03
...
> Your [contributions](https://github.com/shuaibiyy/awesome-terraform/blob/master/contributing.md) ⭐ 6,437 | 🐛 8 | 📅 2026-05-03 are welcome!
...
* [Terraform Bug Tracker](https://github.com/hashicorp/terraform/issues) ⭐ 48,318 | 🐛 1,889 | 🌐 Go | 📅 2026-05-01
* [The Claude Agent Skill for Terraform and OpenTofu - testing, modules, CI/CD, and production patterns](https://github.com/antonbabenko/terraform-skill) ⭐ 1,785 | 🐛 1 | 📅 2026-04-22 - Claude Code skill for Terraform and OpenTofu — testing, module design, CI/CD workflows, and production patterns.
...
* [awesome-terraform-compliance](https://github.com/antonbabenko/awesome-terraform-compliance) ⭐ 109 | 🐛 0 | 📅 2026-04-28 - Curated list of tools, frameworks, and resources for Terraform compliance and security.
...
* [Terraform Best Practices](https://www.terraform-best-practices.com/) - [open-source ebook](https://github.com/antonbabenko/terraform-best-practices) ⭐ 2,457 | 🐛 15 | 🌐 HCL | 📅 2026-03-20
...
* [AWS Lambda the Terraform Way](https://github.com/nsriram/lambda-the-terraform-way) ⭐ 1,262 | 🐛 1 | 🌐 Markdown | 📅 2021-05-08 - Understand AWS Lambda in-depth, beyond executing functions, using Terraform. Also includes guides for integration with S3, API Gateway, DynamoDB, Kinesis, SQS.
...
* [terraform-aws-eks](https://github.com/terraform-aws-modules/terraform-aws-eks) ⭐ 4,933 | 🐛 22 | 🌐 HCL | 📅 2026-04-27 - Creates Elastic Kubernetes Service on AWS (very popular module).
* [terraform-aws-vpc](https://github.com/terraform-aws-modules/terraform-aws-vpc) ⭐ 3,225 | 🐛 25 | 🌐 HCL | 📅 2026-04-02 - Creates VPC resources on AWS (verified and very popular module).
...
* [typhoon](https://github.com/poseidon/typhoon) ⭐ 2,040 | 🐛 7 | 🌐 HCL | 📅 2026-05-04 - Minimal and free Kubernetes distribution with Terraform.
* [terraform-aws-secure-baseline](https://github.com/nozaq/terraform-aws-secure-baseline) ⭐ 1,196 | 🐛 28 | 🌐 HCL | 📅 2024-07-09 - Set up your AWS account with the secure baseline configuration based on CIS Amazon Web Services Foundations.
* [terraform-aws-lambda](https://github.com/terraform-aws-modules/terraform-aws-lambda) ⭐ 1,037 | 🐛 7 | 🌐 HCL | 📅 2026-04-23 - Terraform module, which builds dependencies and packages, and also creates AWS Lambda resources in countless combinations.
* [terraform-aws-rds](https://github.com/terraform-aws-modules/terraform-aws-rds) ⭐ 951 | 🐛 2 | 🌐 HCL | 📅 2026-03-27 - Creates RDS resources on AWS (verified module).
* [terraform-google-project-factory](https://github.com/terraform-google-modules/terraform-google-project-factory) ⭐ 947 | 🐛 21 | 🌐 HCL | 📅 2026-04-20 - Opinionated Google Cloud Platform project creation and configuration with Shared VPC, IAM, APIs, etc.
* [terraform-aws-ec2-instance](https://github.com/terraform-aws-modules/terraform-aws-ec2-instance) ⭐ 806 | 🐛 3 | 🌐 HCL | 📅 2026-03-26 - Creates EC2 instances on AWS.
...
* [terraform-aws-ecs](https://github.com/terraform-aws-modules/terraform-aws-ecs) ⭐ 666 | 🐛 4 | 🌐 HCL | 📅 2026-03-18 - Creates AWS ECS resources on AWS.
* [terraform-aws-security-group](https://github.com/terraform-aws-modules/terraform-aws-security-group) ⭐ 590 | 🐛 5 | 🌐 HCL | 📅 2025-10-21 - Creates EC2-VPC security groups on AWS (verified module).
* [terraform-aws-s3-bucket](https://github.com/terraform-aws-modules/terraform-aws-s3-bucket) ⭐ 577 | 🐛 5 | 🌐 HCL | 📅 2026-04-02 - Creates S3 bucket resources on AWS.
* [terraform-aws-atlantis](https://github.com/terraform-aws-modules/terraform-aws-atlantis) ⭐ 552 | 🐛 1 | 🌐 HCL | 📅 2026-01-08 - Creates Terraform configurations for running [Atlantis](https://runatlantis.io) on AWS Fargate. Github, Gitlab, and BitBucket are supported.
* [terraform-aws-notify-slack](https://github.com/terraform-aws-modules/terraform-aws-notify-slack) ⭐ 493 | 🐛 0 | 🌐 Python | 📅 2026-03-11 - Creates SNS topic and Lambda function, which sends notifications to Slack.
...
* [terraform-aws-rds-aurora](https://github.com/terraform-aws-modules/terraform-aws-rds-aurora) ⭐ 417 | 🐛 4 | 🌐 HCL | 📅 2026-03-18 - Creates RDS Aurora cluster resources on AWS (verified module).
* [terraform-nixos](https://github.com/nix-community/terraform-nixos) ⭐ 407 | 🐛 37 | 🌐 HCL | 📅 2024-08-04 - A set of Terraform modules that are designed to deploy NixOS.
* [terraform-aws-autoscaling](https://github.com/terraform-aws-modules/terraform-aws-autoscaling) ⭐ 311 | 🐛 3 | 🌐 HCL | 📅 2026-02-23 - Creates Auto-Scaling Groups and Launch Configurations (verified module).
...
* [terraform-aws-ecr](https://github.com/cloudposse/terraform-aws-ecr) ⭐ 190 | 🐛 8 | 🌐 HCL | 📅 2026-05-03 - Manages Docker container registries on AWS ECR.
...
* [terraform-aws-route53](https://github.com/terraform-aws-modules/terraform-aws-route53) ⭐ 156 | 🐛 0 | 🌐 HCL | 📅 2026-05-01 - Creates Route53 resources on AWS.
...
* [terraform-cloudflare-maintenance](https://github.com/adinhodovic/terraform-cloudflare-maintenance) ⭐ 128 | 🐛 2 | 🌐 HCL | 📅 2026-04-28 - Module to create a Maintenance Page using Cloudflare Workers.
...
* [terraform-aws-efs](https://github.com/cloudposse/terraform-aws-efs) ⭐ 95 | 🐛 10 | 🌐 HCL | 📅 2026-05-03 - Defines an EFS Filesystem.
...
* [terraform-aws-msk-kafka-cluster](https://github.com/terraform-aws-modules/terraform-aws-msk-kafka-cluster) ⭐ 63 | 🐛 0 | 🌐 HCL | 📅 2026-04-22 - Creates AWS MSK (Managed Streaming for Kafka) resources on AWS.
...
* [citizen](https://github.com/outsideris/citizen) ⭐ 653 | 🐛 45 | 🌐 JavaScript | 📅 2024-10-12 - Private Terraform Module/Provider Registry
* [terralist](https://github.com/terralist/terralist) ⭐ 489 | 🐛 20 | 🌐 Go | 📅 2026-05-02 - Terraform Private Registry for modules and providers manageable from a REST API.
* [Terrareg](https://github.com/matthewjohn/terrareg) ⭐ 339 | 🐛 21 | 🌐 Go | 📅 2026-05-02 - Terraform module registry.
* [boring-registry](https://github.com/boring-registry/boring-registry) ⭐ 271 | 🐛 30 | 🌐 Go | 📅 2026-04-30 - Private Terraform Module/Provider Registry with API key authentication and blob storage support
* [tapir](https://github.com/PacoVK/tapir) ⭐ 237 | 🐛 28 | 🌐 Java | 📅 2026-04-27 - Private Terraform Registry.
...
* [terraform-provider-aws](https://github.com/hashicorp/terraform-provider-aws) ⭐ 10,861 | 🐛 3,450 | 🌐 Go | 📅 2026-05-01 - Provider for Amazon Web Services.
* [terraform-provider-azurerm](https://github.com/hashicorp/terraform-provider-azurerm) ⭐ 4,926 | 🐛 3,844 | 🌐 Go | 📅 2026-05-03 - Provider for Azure.
* [terraform-provider-google](https://github.com/hashicorp/terraform-provider-google) ⭐ 2,609 | 🐛 2,427 | 🌐 Go | 📅 2026-05-04 - Provider for Google Cloud Platform.
* [terraform-provider-kubernetes](https://github.com/hashicorp/terraform-provider-kubernetes) ⭐ 1,708 | 🐛 169 | 🌐 Go | 📅 2026-04-21 - Provider for Kubernetes.
* [terraform-provider-helm](https://github.com/hashicorp/terraform-provider-helm) ⭐ 1,068 | 🐛 143 | 🌐 Go | 📅 2026-04-28 - Provider for Helm.
* [terraform-provider-vsphere](https://github.com/hashicorp/terraform-provider-vsphere) ⭐ 672 | 🐛 128 | 🌐 Go | 📅 2026-05-04 - Provider for VMware vSphere.
...
* [terraform-provider-dominos](https://github.com/nat-henderson/terraform-provider-dominos) ⭐ 1,176 | 🐛 17 | 🌐 Go | 📅 2024-05-28 - Provider for Dominos Pizza.
* [terraform-provider-github](https://github.com/integrations/terraform-provider-github) ⭐ 1,122 | 🐛 343 | 🌐 Go | 📅 2026-05-04 - Provider for GitHub.
* [terraform-provider-keycloak](https://github.com/mrparkers/terraform-provider-keycloak) ⭐ 920 | 🐛 349 | 🌐 Go | 📅 2026-05-04 - Provider to manage the settings of your [Keycloak](https://www.keycloak.org/) identity provider server.
* [terraform-provider-hcloud](https://github.com/hetznercloud/terraform-provider-hcloud) ⭐ 708 | 🐛 60 | 🌐 Go | 📅 2026-05-02 - Provider for Hetzner Cloud.
* [terraform-provider-snowflake](https://github.com/Snowflake-Labs/terraform-provider-snowflake) ⭐ 676 | 🐛 291 | 🌐 Go | 📅 2026-04-30 - Provider for Snowflake data warehouse.
* [terraform-provider-alicloud](https://github.com/aliyun/terraform-provider-alicloud) ⭐ 654 | 🐛 652 | 🌐 Go | 📅 2026-04-30 - Provider for Alibaba Cloud.
* [terraform-provider-digitalocean](https://github.com/digitalocean/terraform-provider-digitalocean) ⭐ 563 | 🐛 174 | 🌐 Go | 📅 2026-04-28 - Provider for DigitalOcean.
* [terraform-provider-openstack](https://github.com/terraform-provider-openstack/terraform-provider-openstack) ⭐ 468 | 🐛 192 | 🌐 Go | 📅 2026-04-27 - Plugin for OpenStack.
* [terraform-provider-datadog](https://github.com/DataDog/terraform-provider-datadog) ⭐ 443 | 🐛 342 | 🌐 Go | 📅 2026-05-01 - Provider for Datadog.
* [terraform-provider-gitlab](https://github.com/gitlabhq/terraform-provider-gitlab) ⭐ 427 | 🐛 111 | 📅 2026-04-17 - Provider for GitLab.
* [terraform-provider-azuredevops](https://github.com/microsoft/terraform-provider-azuredevops) ⭐ 426 | 🐛 220 | 🌐 Go | 📅 2026-04-30 - Provider for Azure DevOps (VSTS).
* [terraform-provider-ibm](https://github.com/IBM-Cloud/terraform-provider-ibm) ⭐ 362 | 🐛 751 | 🌐 Go | 📅 2026-05-04 - Provider for IBM Cloud.
...
* [terraform-provider-rancher2](https://github.com/rancher/terraform-provider-rancher2) ⭐ 292 | 🐛 143 | 🌐 Go | 📅 2026-04-28 - Provider for Rancher v2.
* [terraform-provider-artifactory](https://github.com/jfrog/terraform-provider-artifactory) ⭐ 287 | 🐛 66 | 🌐 Go | 📅 2026-05-04 - Provider for [JFrog Artifactory](https://jfrog.com/artifactory/).
...
* [terraform-provider-azapi](https://github.com/Azure/terraform-provider-azapi) ⭐ 237 | 🐛 116 | 🌐 Go | 📅 2026-05-04 - Provider for Azure Resource Manager Rest API
* [terraform-provider-elasticstack](https://github.com/elastic/terraform-provider-elasticstack) ⭐ 207 | 🐛 157 | 🌐 Go | 📅 2026-05-04 - Provider for Elasticsearch and Kibana.
...
* [terraform-provider-panos](https://github.com/PaloAltoNetworks/terraform-provider-panos) ⭐ 110 | 🐛 150 | 🌐 Go | 📅 2026-04-28 - Provider for [Palo Alto Networks next-generation firewalls](https://www.paloaltonetworks.com/network-security).
* [terraform-provider-heroku](https://github.com/heroku/terraform-provider-heroku) ⭐ 103 | 🐛 40 | 🌐 Go | 📅 2026-04-14 - Provider for Heroku.
* [terraform-provider-ucloud](https://github.com/ucloud/terraform-provider-ucloud) ⭐ 73 | 🐛 23 | 🌐 Go | 📅 2026-04-14 - Provider to manage UCloud resources.
...
* [terraform-provider-spotinst](https://github.com/spotinst/terraform-provider-spotinst) ⭐ 64 | 🐛 33 | 🌐 Go | 📅 2026-04-28 - Provider for spotinst.
* [terraform-provider-atlas](https://github.com/ariga/terraform-provider-atlas) ⭐ 63 | 🐛 15 | 🌐 Go | 📅 2026-04-23 - Provider for [Atlas](https://atlasgo.io/).
* [terraform-provider-buildkite](https://github.com/buildkite/terraform-provider-buildkite) ⭐ 59 | 🐛 18 | 🌐 Go | 📅 2026-05-04 - Provider for Buildkite.
* [terraform-provider-coder](https://github.com/coder/terraform-provider-coder) ⭐ 59 | 🐛 40 | 🌐 Go | 📅 2026-04-29 - Provider for [Coder](https://coder.com)
* [terraform-provider-graphql](https://github.com/sullivtr/terraform-provider-graphql) ⭐ 59 | 🐛 7 | 🌐 Go | 📅 2026-01-22 - Provider for GraphQL queries and mutations.
* [terraform-provider-confluent](https://github.com/confluentinc/terraform-provider-confluent) ⭐ 55 | 🐛 119 | 🌐 Go | 📅 2026-05-03 - Provider for Confluent.
...
* [terraform-provider-checkly](https://github.com/checkly/terraform-provider-checkly) ⭐ 43 | 🐛 8 | 🌐 Go | 📅 2026-04-29 - Manage [Checkly](https://www.checklyhq.com) resources for API & E2E monitoring.
* [terraform-provider-env0](https://github.com/env0/terraform-provider-env0) ⭐ 41 | 🐛 10 | 🌐 Go | 📅 2026-05-03 - Provider for [env0](https://www.env0.com/)
...
* [terraform-provider-sigsci](https://github.com/signalsciences/terraform-provider-sigsci) ⭐ 26 | 🐛 13 | 🌐 Go | 📅 2026-03-19 - Provider for Signal Sciences.
* [terraform-provider-planetscale](https://github.com/planetscale/terraform-provider-planetscale) ⭐ 24 | 🐛 19 | 🌐 Go | 📅 2026-04-17 -  Terraform provider for [PlanetScale](https://planetscale.com) (Vitess & Postgres).
...
* [terraform-provider-scalr](https://github.com/Scalr/terraform-provider-scalr) ⭐ 19 | 🐛 5 | 🌐 Go | 📅 2026-05-01 - Provider for [Scalr](https://www.scalr.com/)
* [terraform-provider-qovery](https://github.com/Qovery/terraform-provider-qovery) ⭐ 18 | 🐛 14 | 🌐 Go | 📅 2026-04-30 - Provider for [Qovery](https://www.qovery.com/) — manage Kubernetes deployments, environments, applications, databases, Helm charts, and Terraform services on AWS, GCP, Azure, and Scaleway.
...
* [terraform-provider-proxmox](https://github.com/Telmate/terraform-provider-proxmox) ⭐ 2,886 | 🐛 127 | 🌐 Go | 📅 2026-04-23 - Terraform Proxmox provider.
* [terraform-provider-docker](https://github.com/kreuzwerker/terraform-provider-docker) ⭐ 795 | 🐛 44 | 🌐 Go | 📅 2026-05-02 - Terraform Docker provider.
* [terraform-provider-minio](https://github.com/aminueza/terraform-provider-minio) ⭐ 335 | 🐛 10 | 🌐 Go | 📅 2026-04-28 - Terraform provider for managing MinIO S3 buckets and IAM Users.
* [terraform-provider-terracurl](https://github.com/devops-rob/terraform-provider-terracurl) ⭐ 160 | 🐛 30 | 🌐 Go | 📅 2026-05-01 - Provider to make managed and unmanaged API calls to your target endpoint.
...
* [terraform-provider-multipass](https://github.com/todoroff/terraform-provider-multipass) ⭐ 6 | 🐛 0 | 🌐 Go | 📅 2026-04-24 - Terraform provider for Multipass.
...
* [terratest](https://github.com/gruntwork-io/terratest) ⭐ 7,912 | 🐛 86 | 🌐 Go | 📅 2026-05-04 - Terratest is a Go library that makes it easier to write automated tests for your infrastructure code.
* [terraform-compliance](https://github.com/terraform-compliance/cli) ⭐ 1,450 | 🐛 96 | 🌐 Python | 📅 2025-12-08 - BDD Testing for Terraform Files.
...
* [terraform-bundle](https://github.com/hashicorp/terraform/tree/main/tools/terraform-bundle) ⭐ 48,318 | 🐛 1,889 | 🌐 Go | 📅 2026-05-01 - Easily builds bundles containing a Terraform binary as well as provider binaries. Useful for CI and air-gapped Terraform Enterprise.
* [Infracost](https://github.com/infracost/infracost) ⭐ 12,279 | 🐛 29 | 🌐 Go | 📅 2026-05-03 - Cloud cost estimates for Terraform in your CLI and pull requests.
* [terragrunt](https://github.com/gruntwork-io/terragrunt) ⭐ 9,552 | 🐛 228 | 🌐 Go | 📅 2026-05-01 - Terragrunt is a thin wrapper for Terraform that provides extra tools for keeping your Terraform configurations DRY, working with multiple Terraform modules, and managing remote state.
* [atlantis](https://github.com/runatlantis/atlantis) ⭐ 9,048 | 🐛 848 | 🌐 Go | 📅 2026-05-04 - Unified workflow for collaborating on Terraform through GitHub.
* [Checkov](https://github.com/bridgecrewio/checkov/) ⭐ 8,686 | 🐛 147 | 🌐 Python | 📅 2026-04-30 - Terraform static analysis tool for terraform>=0.12
* [tfsec](https://github.com/aquasecurity/tfsec) ⭐ 6,992 | 🐛 15 | 🌐 Go | 📅 2026-03-25 - Terraform static analysis tool that supports terraform <0.12 & >=0.12 & directly integrates with HCL parser for better results.
* [tflint](https://github.com/terraform-linters/tflint) ⭐ 5,697 | 🐛 30 | 🌐 Go | 📅 2026-05-02 - Terraform linter for detecting errors that can not be detected by `terraform plan`
...
* [tfenv](https://github.com/tfutils/tfenv) ⭐ 4,918 | 🐛 24 | 🌐 Shell | 📅 2026-05-01 - Terraform version manager inspired by rbenv.
* [terraform-docs](https://github.com/terraform-docs/terraform-docs) ⭐ 4,769 | 🐛 175 | 🌐 Go | 📅 2026-04-30 - Quick utility to generate docs from terraform modules.
...
* [pre-commit-terraform](https://github.com/antonbabenko/pre-commit-terraform) ⭐ 3,702 | 🐛 28 | 🌐 Shell | 📅 2026-04-21 - pre-commit git hooks for Terraform and Terragrunt: auto-format, validate, update docs, run security checks, estimate costs, and more.
* [terramate](https://github.com/terramate-io/terramate) ⭐ 3,578 | 🐛 92 | 🌐 Go | 📅 2026-04-23 - Tool for managing multiple Terraform stacks that comes with support for change detection and code generation
* [rover](https://github.com/im2nguyen/rover) ⭐ 3,295 | 🐛 45 | 🌐 Go | 📅 2025-07-30 - Interactive Terraform state and configuration explorer.
* [driftctl](https://github.com/snyk/driftctl) ⭐ 2,637 | 🐛 151 | 🌐 Go | 📅 2026-04-16 - Detect, track, and alert on infrastructure drift :skull:
* [KICS](https://github.com/Checkmarx/kics) ⭐ 2,629 | 🐛 301 | 🌐 Open Policy Agent | 📅 2026-04-22 - Scans IaC projects for security vulnerabilities, compliance issues, and infrastructure misconfiguration. Currently working with Terraform projects, Kubernetes manifests, Dockerfiles, AWS CloudFormation Templates, and Ansible playbooks.
* [former2](https://github.com/iann0036/former2) ⭐ 2,399 | 🐛 181 | 🌐 JavaScript | 📅 2025-06-12 - Generate terraform configuration from your existing resources within your AWS account.
* [terracognita](https://github.com/cycloidio/terracognita) ⭐ 2,366 | 🐛 94 | 🌐 Go | 📅 2025-09-02 - Reads from existing Cloud Providers (reverse Terraform) and generates your infrastructure as code on Terraform configuration.
...
* [inframap](https://github.com/cycloidio/inframap) ⭐ 2,015 | 🐛 49 | 🌐 Go | 📅 2026-04-23 - Read your tfstate or HCL to generate a graph specific for each provider, showing only the resources that are most important/relevant.
* [terraboard](https://github.com/camptocamp/terraboard) ⭐ 2,007 | 🐛 21 | 🌐 Go | 📅 2026-04-22 - Web dashboard to inspect Terraform States.
* [aztfexport](https://github.com/Azure/aztfexport) ⭐ 1,884 | 🐛 47 | 🌐 Go | 📅 2026-04-02 - A tool to bring existing Azure resources under Terraform's management.
...
* [terravision](https://github.com/patrickchugh/terravision) ⭐ 1,500 | 🐛 6 | 🌐 Python | 📅 2026-04-30 - Generates professional cloud architecture diagrams from Terraform code using official AWS/Azure/GCP icons and design standards. Runs 100% client-side with CI/CD integration.
* [tenv](https://github.com/tofuutils/tenv) ⭐ 1,364 | 🐛 41 | 🌐 Go | 📅 2026-04-29 - OpenTofu/Terraform/Terragrunt version manager.
* [cf-terraforming](https://github.com/cloudflare/cf-terraforming) ⭐ 1,356 | 🐛 12 | 🌐 Go | 📅 2026-05-02 A command line utility to facilitate terraforming your existing Cloudflare resources.
* [atmos](https://github.com/cloudposse/atmos) ⭐ 1,293 | 🐛 274 | 🌐 Go | 📅 2026-05-04 - A universal tool that converts deep merged YAML to module inputs. :alien:
* [tftui](https://github.com/idoavrah/terraform-tui) ⭐ 1,281 | 🐛 11 | 🌐 Python | 📅 2024-07-09 - A textual user interface for Terraform state.
* [tfmigrate](https://github.com/minamijoyo/tfmigrate) ⭐ 1,267 | 🐛 23 | 🌐 Go | 📅 2026-05-01 - A Terraform state migration tool for GitOps.
...
* [tfk8s](https://github.com/jrhouston/tfk8s) ⭐ 1,056 | 🐛 25 | 🌐 Go | 📅 2024-01-17 - A tool for converting Kubernetes YAML manifests to Terraform HCL
* [terratag](https://github.com/env0/terratag) ⭐ 1,049 | 🐛 6 | 🌐 Go | 📅 2026-04-23 - Terratag is a CLI tool that enables users of Terraform to automatically create and maintain tags across their entire set of AWS, Azure, and GCP resources.
* [yj](https://github.com/sclevine/yj) ⭐ 1,040 | 🐛 24 | 🌐 Go | 📅 2024-01-01 - CLI - Convert between YAML, TOML, JSON, and HCL. Preserves map order.
...
* [yor](https://github.com/bridgecrewio/yor) ⭐ 923 | 🐛 12 | 🌐 Go | 📅 2026-04-23 - Automatically tag and trace infrastructure as code frameworks (Terraform, Cloudformation, and Serverless).
* [pike](https://github.com/jamesWoolfenden/pike) ⭐ 899 | 🐛 9 | 🌐 HCL | 📅 2026-05-04 - Pike calculates the permissions or IAM policy required to build your Terraform.
* [tfautomv](https://github.com/busser/tfautomv) ⭐ 891 | 🐛 16 | 🌐 Go | 📅 2026-04-29 - Generate Terraform `moved` blocks automatically for painless refactoring
* [serverless.tf - Doing serverless with Terraform](https://serverless.tf/) - serverless.tf is an opinionated open-source framework for developing, building, deploying, and securing serverless applications and infrastructures on AWS using Terraform. [Read more](https://github.com/antonbabenko/serverless.tf) ⭐ 870 | 🐛 1 | 📅 2025-03-19.
...
* [iam-policy-json-to-terraform](https://github.com/flosell/iam-policy-json-to-terraform) ⭐ 818 | 🐛 14 | 🌐 JavaScript | 📅 2026-04-27 - Small tool to convert an IAM Policy in JSON format into a Terraform aws\_iam\_policy\_document
...
* [aws2tf](https://github.com/aws-samples/aws2tf) ⭐ 746 | 🐛 0 | 🌐 Python | 📅 2026-04-11 - automates the importing of existing AWS resources into Terraform and outputs the Terraform HCL code.
...
* [tf-summarize](https://github.com/dineshba/tf-summarize) ⭐ 698 | 🐛 26 | 🌐 Go | 📅 2026-03-20 - A command-line utility to print the summary of the terraform plan
* [pug](https://github.com/leg100/pug) ⭐ 678 | 🐛 20 | 🌐 Go | 📅 2026-01-02 - The terminal user interface for terraform power users.
...
* [tfupdate](https://github.com/minamijoyo/tfupdate) ⭐ 648 | 🐛 14 | 🌐 Go | 📅 2025-11-20 - Update version constraints in your Terraform configurations.
* [hcledit](https://github.com/minamijoyo/hcledit) ⭐ 535 | 🐛 21 | 🌐 Go | 📅 2025-04-10 - A command line editor for HCL.
* [tfcmt](https://github.com/suzuki-shunsuke/tfcmt) ⭐ 525 | 🐛 35 | 🌐 Go | 📅 2026-05-03 - CLI to notify the result of plan and apply as Pull Request comment.
* [json2hcl](https://github.com/kvz/json2hcl) ⚠️ Archived - Convert JSON to HCL and vice versa. :ghost:
* [hcl2json](https://github.com/tmccombs/hcl2json) ⭐ 473 | 🐛 10 | 🌐 Go | 📅 2026-04-20 - Convert hcl2 to json.
* [threatcl](https://github.com/threatcl/threatcl) ⭐ 458 | 🐛 15 | 🌐 Go | 📅 2026-04-12 - Documenting your Threat Models with HCL
...
* [terraform-operator](https://github.com/GalleyBytes/terraform-operator) ⭐ 382 | 🐛 26 | 🌐 Go | 📅 2025-12-09 - A Kubernetes CRD to handle Terraform operations.
* [tfaction](https://github.com/suzuki-shunsuke/tfaction) ⭐ 382 | 🐛 64 | 🌐 TypeScript | 📅 2026-05-04 - GitHub Actions collection for Opinionated Terraform Workflow
...
* [tfmcp](https://github.com/nwiizo/tfmcp) ⭐ 363 | 🐛 0 | 🌐 Rust | 📅 2026-03-26 - A CLI tool that helps you interact with Terraform via the Model Context Protocol (MCP), allowing AI assistants like Claude to manage and operate Terraform environments.
...
* [pipeform](https://github.com/magodo/pipeform) ⭐ 350 | 🐛 1 | 🌐 Go | 📅 2025-01-31 - Terraform runtime TUI
* [terraform-iam-policy-validator](https://github.com/awslabs/terraform-iam-policy-validator) ⭐ 347 | 🐛 15 | 🌐 Python | 📅 2025-06-09 - CLI validates AWS IAM Policies in a Terraform template against AWS IAM best practices.
* [terracost](https://github.com/cycloidio/terracost) ⭐ 342 | 🐛 22 | 🌐 Go | 📅 2025-11-24 - Cloud cost estimation for Terraform in your CLI.
* [terraform-aws-clickops-notifier](https://github.com/cloudandthings/terraform-aws-clickops-notifier) ⭐ 333 | 🐛 25 | 🌐 Python | 📅 2026-04-09 - Get notified when actions are taken in the AWS Console.
* [tfschema](https://github.com/minamijoyo/tfschema) ⭐ 315 | 🐛 4 | 🌐 Go | 📅 2026-05-01 - Schema inspector for Terraform providers.
* [fogg](https://github.com/chanzuckerberg/fogg) ⭐ 307 | 🐛 5 | 🌐 Go | 📅 2026-04-24 - A tool for eliminating toil in managing terraform repositories.
* [tfscaffold](https://github.com/tfutils/tfscaffold) ⭐ 280 | 🐛 1 | 🌐 HCL | 📅 2026-04-24 - Framework for controlling multi-environment multi-component terraform-managed AWS infrastructure.
...
* [asdf](https://github.com/asdf-community/asdf-hashicorp) ⭐ 264 | 🐛 16 | 🌐 Shell | 📅 2026-01-01 - HashiCorp plugin for the [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,323 | 🐛 168 | 🌐 Go | 📅 2026-05-02 version manager
* [tfsort](https://github.com/AlexNabokikh/tfsort) ⭐ 237 | 🐛 13 | 🌐 Go | 📅 2025-10-01 - CLI utility to sort Terraform variables and outputs.
...
* [tofuenv](https://github.com/tofuutils/tofuenv) ⭐ 229 | 🐛 21 | 🌐 Shell | 📅 2026-02-10 - OpenTofu version manager inspired by tfenv
...
* [tfmv](https://github.com/suzuki-shunsuke/tfmv) ⭐ 159 | 🐛 4 | 🌐 Go | 📅 2026-05-03 - Rename Terraform resources and generate moved blocks
* [tftree](https://github.com/busser/tftree) ⭐ 158 | 🐛 8 | 🌐 Go | 📅 2026-04-30 - Display your Terraform module call stack in your terminal.
...
* [redc](https://github.com/wgpsec/redc) ⭐ 153 | 🐛 1 | 🌐 Go | 📅 2026-05-01 - Next-generation red team infrastructure automation tool built on Terraform, supporting multi-cloud deployment (Alibaba Cloud, Tencent Cloud, AWS, etc.) with one-command deployment for creating, configuring, and destroying red team environments.
...
* [cfnctl](https://github.com/rogerwelin/cfnctl) ⭐ 135 | 🐛 5 | 🌐 Go | 📅 2026-04-14 - Cfnctl brings the Terraform cli experience to AWS Cloudformation.
* [terraform-repl](https://github.com/paololazzari/terraform-repl) ⭐ 135 | 🐛 3 | 🌐 Shell | 📅 2024-11-30 - A terraform console wrapper for a better interactive console experience.
...
* [ruby-terraform](https://github.com/infrablocks/ruby_terraform) ⭐ 112 | 🐛 5 | 🌐 Ruby | 📅 2026-04-20 - Simple Ruby wrapper for invoking terraform commands.
* [sato](https://github.com/JamesWoolfenden/sato) ⭐ 109 | 🐛 0 | 🌐 Go | 📅 2026-05-03 - Sato helps you convert your legacy Cloudformation into Terraform.
* [tgf](https://github.com/coveooss/tgf) ⭐ 109 | 🐛 3 | 🌐 Go | 📅 2026-04-30 - Terragrunt frontend for executing Terragrunt/Terraform through Docker.
...
* [tfprovidercheck](https://github.com/suzuki-shunsuke/tfprovidercheck) ⭐ 88 | 🐛 8 | 🌐 Go | 📅 2026-05-03 - CLI to prevent malicious Terraform Providers from being executed
...
* [drifthound](https://github.com/treezio/drifthound) ⭐ 61 | 🐛 15 | 🌐 Ruby | 📅 2026-04-23 - Continuous infrastructure drift detection with historical tracking and notifications.
...
* [cloud-audit](https://github.com/gebalamariusz/cloud-audit) ⭐ 54 | 🐛 5 | 🌐 Python | 📅 2026-04-28 - AWS security auditing CLI with remediation engine that generates Terraform code for fixing misconfigurations.
* [renovate-config](https://github.com/SpotOnInc/renovate-config) ⭐ 53 | 🐛 3 | 📅 2026-04-28 - Sharable Config Presets for Renovatebot, especially useful for DevOps folks.
...
* [terrascope](https://github.com/spilliams/terrascope) ⭐ 27 | 🐛 47 | 🌐 Go | 📅 2026-05-04 - Build orchestrator for terraform monorepos.
...
* [terraformer](https://github.com/chenrui333/terraformer) ⭐ 4 | 🐛 8 | 🌐 Go | 📅 2026-05-03 - CLI tool to generate terraform files from existing infrastructure. Infrastructure to Code. Supported many providers.
...
* [terradozer](https://github.com/chenrui333/terradozer) ⭐ 1 | 🐛 10 | 🌐 Go | 📅 2026-05-04 - Terraform destroy without configuration files.
...
* [setup-terraform](https://github.com/hashicorp/setup-terraform) ⭐ 1,570 | 🐛 70 | 🌐 JavaScript | 📅 2026-04-27 - Sets up Terraform CLI in your GitHub Actions workflow.
* [terraform-plan](https://github.com/cds-snc/terraform-plan) ⭐ 64 | 🐛 17 | 🌐 JavaScript | 📅 2026-05-02 - GitHub Action to run Terraform plan and add a comment with the changes.

### IDE

* [vscode-terraform-live-graph](https://github.com/adamiBs/vscode-terraform-live-graph) ⭐ 240 | 🐛 16 | 🌐 TypeScript | 📅 2023-06-12 - Terraform Live Graph Extension for Visual Studio Code is a plugin that allows you to generate a live Terraform graph as you code.
...
* [python-hcl2](https://github.com/amplify-education/python-hcl2/) ⭐ 305 | 🐛 10 | 🌐 Python | 📅 2026-04-28 - HCL2 parser in Python
* [hcl-rs](https://github.com/martinohmann/hcl-rs) ⭐ 177 | 🐛 11 | 🌐 Rust | 📅 2026-05-01 - HCL parsing and encoding libraries for rust with serde support
* [tree-sitter-hcl](https://github.com/tree-sitter-grammars/tree-sitter-hcl) ⭐ 138 | 🐛 7 | 🌐 HCL | 📅 2026-01-17 - HCL grammar for tree-sitter
...
* [nu\_plugin\_hcl](https://github.com/Yethal/nu_plugin_hcl) ⭐ 13 | 🐛 0 | 🌐 Rust | 📅 2026-04-15 - HCL parser plugin for [Nushell](https://github.com/nushell/nushell) ⭐ 39,336 | 🐛 1,498 | 🌐 Rust | 📅 2026-05-02
...
* [Burrito](https://github.com/padok-team/burrito) ⭐ 715 | 🐛 73 | 🌐 Go | 📅 2026-05-04 - TACoS Kubernetes Operator - "ArgoCD for Terraform"
* [OTF](https://github.com/leg100/otf) ⭐ 673 | 🐛 11 | 🌐 Go | 📅 2026-04-30 - Open Terraforming Framework, an open source alternative to Terraform Enterprise with full Terraform CLI integration.
* [Lynx](https://github.com/clivern/lynx) ⭐ 365 | 🐛 9 | 🌐 Elixir | 📅 2026-04-29 - Fast, Secure and Reliable Terraform Backend. It has a user-friendly dashboard, project and environment management, state versioning, locking and snapshots support.
* [Stack-Lifecycle-Deployment](https://github.com/D10S0VSkY-OSS/Stack-Lifecycle-Deployment) ⭐ 262 | 🐛 20 | 🌐 CSS | 📅 2026-04-21 - OpenSource solution that defines and manages the complete lifecycle of resources used and provisioned into a cloud.
...
* [Terraform-ls](https://github.com/hashicorp/terraform-ls) ⭐ 1,173 | 🐛 250 | 🌐 Go | 📅 2026-04-30 (Terraform Language Server)
